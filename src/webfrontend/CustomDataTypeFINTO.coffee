          ...
          top:
            content: [
                new CUI.PaneHeader
                    left:
                        content:
                            new CUI.Label(text: $$('custom.data.type.finto.modal.form.popup.choose_manual_label'))
            ]
          center:
            content: [
              prefLabelButtons
                        ...
                        top:
                            content: [
                                new CUI.PaneHeader
                                    left:
                                        content:
                                            new CUI.Label(text: $$('custom.data.type.finto.modal.form.popup.choose'))
                                    right:
                                        content:
                                            new CUI.EmptyLabel
            ...
            content: [
                new CUI.PaneHeader
                    left:
                        content:
                            new CUI.Label
                              text: $$('custom.data.type.finto.modal.form.popup.choose') + ': ' + that.getVocabularyNameFromDatamodel()
                              class: "finto_popup_title"
            ]
        center:
            content: [
                treeview.treeview
